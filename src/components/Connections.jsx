...
const Connections = () => {
    ...
    if(userConnections.length === 0) return <div className="flex justify-center mt-5 min-h-screen text-rose-400 text-base md:text-xl"><h2>No Connections Found!</h2></div>
                ...
                userConnections.map(connection=>{
                    ...
                    return (
                        <div key={_id} className="w-11/12 sm:w-9/12 md:w-7/12 lg:w-6/12 flex bg-base-300 rounded-lg shadow-lg shadow-slate-700 whitespace-nowrap overflow-hidden text-ellipsis">
                            <div className="w-5/12 sm:w-4/12 md:w-4/12 p-3 flex justify-center">
                                <img alt="profile-pic" className="w-[100px] md:w-[130px] h-[100px] md:h-[130px] object-cover rounded-full" src={photoUrl}/>
                            </div>
                            <div className="w-7/12 sm:w-8/12 md:w-8/12 p-3 flex flex-col gap-1 justify-center">
                                {
                                    firstName && lastName && 
