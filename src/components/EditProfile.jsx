  ...
  return (
    <div className="flex justify-center gap-10 flex-wrap">
      <div className="mt-10 bg-base-300 p-8 rounded-xl w-[90%] sm:w-[380px]  flex-shrink-0 shadow-md shadow-gray-600">
        <form onSubmit={(e) => e.preventDefault()}>
          <div className="text-xl font-medium flex items-center justify-center mb-4">
            ...
            <span className="ms-1 text-2xl text-rose-400">Edit Profile</span>
          </div>
          ...
          <div className="flex justify-center">
            <button
              className="mt-6 bg-rose-400 py-2 w-3/4 rounded-md text-lg font-medium hover:opacity-80 text-slate-950"
      ...
      <div className="mt-10 flex-shrink-0">
        <h2 className="text-xl font-semibold text-center bg-base-300 p-3 text-rose-400 mb-4">
